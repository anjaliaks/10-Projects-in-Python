import datetime
users = {"Asha":"1234","Ketan":"5678","Divya":"9999"}
admins = {"Anjali":"2206"}
usact = {"Asha":{"balance":2000,"deposits":[],"withdrawal":[],"transfer":[]},"Ketan":{"balance":3500,"deposits":[],"withdrawal":[],"transfer":[]},"Divya":{"balance":1750,"deposits":[],"withdrawal":[],"transfer":[]}}
def main():
...
def login(users):
    while True:
        ...
        if usname not in users:
            ...
            print(usname + " Welcome to Your Bank." )
            break
    ...
    while True:
        ...
        if ask == "1":
           ...
           transfer(users,usact,usname,passwrd)
            ...
            print("You are loggin out. Thank you for choosing Your Bank. Whish to see you again")
            main()
        else:
    ...
    while True:
        ...
        if select == "1":
            ...
            if remove not in users:
                print(remove+" does not exist as an user to Your Bank.")
                admin(users,usact)
            else:
                users.pop(remove)
                usact.pop(remove)
                print(remove+" was removed as an user to Your Bank")
                admin(users,usact)
        elif select == "3":
            c = 1
            for i in users:
